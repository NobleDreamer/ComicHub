...
```bash
git remote add encore encore://comic-sharing-platform-2y72
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/comic-sharing-platform-2y72/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/comic-sharing-platform-2y72/settings/integrations/github)
